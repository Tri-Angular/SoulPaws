...
export class PetProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.petProfileService.getPetProfileById(petProfileId).subscribe((data: any) => {
  ...
  initiateAdoption(): void {
    ...
    this.petProfileService.initiateAdoption(this.adoptionRequest).subscribe((response: any) => {
